/**
 * Multiple_Network.cjs - Test sending multiple jobs via AME Web Service (Network IP)
 */

const http = require('http')
const { exec, spawn } = require('child_process')

// Connection settings - NETWORK IP
...
async function run() {
  ...
  console.log('Multiple Jobs Test - NETWORK IP (' + HOST + ':' + PORT + ')')
  console.log('='.repeat(60))
